...
if("TRUE" STREQUAL "TRUE")
  set(beginner_tutorials_SOURCE_PREFIX /home/rahuldeo/ATOM/ATOM_DRONE/ros/rosatom1/src/beginner_tutorials)
  set(beginner_tutorials_DEVEL_PREFIX /home/rahuldeo/ATOM/ATOM_DRONE/ros/rosatom1/devel)
  ...
  set(beginner_tutorials_INSTALL_PREFIX /home/rahuldeo/ATOM/ATOM_DRONE/ros/rosatom1/install)
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'beginner_tutorials' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  Ask the maintainer 'rahuldeo <rahuldeo@todo.todo>' to fix it.")
      endif()
    else()
      message(FATAL_ERROR "Project 'beginner_tutorials' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/rahuldeo/ATOM/ATOM_DRONE/ros/rosatom1/src/beginner_tutorials/${idir}'.  Ask the maintainer 'rahuldeo <rahuldeo@todo.todo>' to fix it.")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/rahuldeo/ATOM/ATOM_DRONE/ros/rosatom1/devel/lib;/home/rahuldeo/ATOM/ATOM_DRONE/ros/rosatom/devel/lib;/opt/ros/kinetic/lib)
