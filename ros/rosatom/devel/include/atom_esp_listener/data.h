// Generated by gencpp from file atom_esp_listener/data.msg
// DO NOT EDIT!


#ifndef ATOM_ESP_LISTENER_MESSAGE_DATA_H
#define ATOM_ESP_LISTENER_MESSAGE_DATA_H
...
struct data_
{
  ...
  typedef boost::shared_ptr< ::atom_esp_listener::data_<ContainerAllocator> > Ptr;
  typedef boost::shared_ptr< ::atom_esp_listener::data_<ContainerAllocator> const> ConstPtr;

}; // struct data_

typedef ::atom_esp_listener::data_<std::allocator<void> > data;

typedef boost::shared_ptr< ::atom_esp_listener::data > dataPtr;
typedef boost::shared_ptr< ::atom_esp_listener::data const> dataConstPtr;
...
std::ostream& operator<<(std::ostream& s, const ::atom_esp_listener::data_<ContainerAllocator> & v)
{
ros::message_operations::Printer< ::atom_esp_listener::data_<ContainerAllocator> >::stream(s, "", v);
return s;
}
...
template <class ContainerAllocator>
struct IsFixedSize< ::atom_esp_listener::data_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::atom_esp_listener::data_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct IsMessage< ::atom_esp_listener::data_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsMessage< ::atom_esp_listener::data_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct HasHeader< ::atom_esp_listener::data_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct HasHeader< ::atom_esp_listener::data_<ContainerAllocator> const>
  : FalseType
  { };


template<class ContainerAllocator>
struct MD5Sum< ::atom_esp_listener::data_<ContainerAllocator> >
{
  ...
  static const char* value(const ::atom_esp_listener::data_<ContainerAllocator>&) { return value(); }
  static const uint64_t static_value1 = 0x468ea019e00a2e85ULL;
  static const uint64_t static_value2 = 0x450ca1ffc75e76acULL;
};

template<class ContainerAllocator>
struct DataType< ::atom_esp_listener::data_<ContainerAllocator> >
{
  static const char* value()
  {
...
template<class ContainerAllocator>
struct Definition< ::atom_esp_listener::data_<ContainerAllocator> >
{
  static const char* value()
  {
    return "int16  mpuData_AcX\n\
int16  mpuData_AcY\n\
int16  mpuData_AcZ\n\
...
namespace serialization
{
  ...
  template<class ContainerAllocator> struct Serializer< ::atom_esp_listener::data_<ContainerAllocator> >
  {
...
template<class ContainerAllocator>
struct Printer< ::atom_esp_listener::data_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::atom_esp_listener::data_<ContainerAllocator>& v)
  {
...
#endif // ATOM_ESP_LISTENER_MESSAGE_DATA_H
