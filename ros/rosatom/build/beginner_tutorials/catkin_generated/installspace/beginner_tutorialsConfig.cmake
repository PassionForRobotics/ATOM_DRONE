...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'beginner_tutorials' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/rahuldeo/ATOM/ATOM_DRONE/ros/rosatom1/install/${idir}'.  Ask the maintainer 'rahuldeo <rahuldeo@todo.todo>' to fix it.")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/rahuldeo/ATOM/ATOM_DRONE/ros/rosatom1/install/lib;/home/rahuldeo/ATOM/ATOM_DRONE/ros/rosatom/devel/lib;/opt/ros/kinetic/lib)
